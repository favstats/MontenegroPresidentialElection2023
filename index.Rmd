---
title: "Montenegrin presidential election 2023"
...
color_dat <- tibble(
  colors = c("#e6194B", "#f5911d", "#00008b", "green", "#524fa1", "#ff1a1a", "#f1c851", "#f04949", "#6495ed", "#2598d4", "#89cff0", "#89cff0", "#9A6324", "#fffac8", "#800000"),
...
gg <- coltototal30 %>% 
  ...
  mutate(target = case_when(
    ...
    target == "countries" ~ "GEOGRAPHY: Montenegro",
